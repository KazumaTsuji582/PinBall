...
public class FripperController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ((Input.GetKeyDown(KeyCode.LeftArrow) || Input.GetKeyDown(KeyCode.A)) && tag == "LeftFripperTag")    //片方動かすためにtagチェックしてる
        {
        ...
        if ((Input.GetKeyDown(KeyCode.DownArrow) || Input.GetKeyDown(KeyCode.S)) && (tag == "LeftFripperTag" || tag == "RightFripperTag")) //両方動かすならTagチェックいらない
        {
            SetAngle(this.flickAngle);
        }
